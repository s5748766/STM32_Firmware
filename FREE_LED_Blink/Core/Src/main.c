...
/* Definitions for Button_push */
osThreadId_t Button_pushHandle;
const osThreadAttr_t Button_push_attributes = {
  .name = "Button_push",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityLow,
};
/* Definitions for Toggle_LED */
osThreadId_t Toggle_LEDHandle;
const osThreadAttr_t Toggle_LED_attributes = {
  .name = "Toggle_LED",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityLow,
};
...
int main(void)
{
  ...
  /* creation of Button_push */
  Button_pushHandle = osThreadNew(StartTask02, NULL, &Button_push_attributes);

  /* creation of Toggle_LED */
  Toggle_LEDHandle = osThreadNew(StartTask03, NULL, &Toggle_LED_attributes);
